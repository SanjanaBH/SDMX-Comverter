...
class FirstPage
    ...
    public void actionPerformed(ActionEvent e)
    {
        if (e.getSource() == sub) {
            if (sub.isSelected()) {
				...
				//Registration12 page1 =new Registration12();
				//page1.setVisible(true);
			
            }
			//Registration12 r1 =new Registration12();
			//r1.setVisible(true);
			...
			JComboBox Element;
			String Elements[]
			= { "Element1", "Element2", "version3", "version4",
            "May", "Jun", "July", "Aug",
            "Sup", "Oct", "Nov", "Dec" };
	...
	s.setVisible(true);*/
	//Registration12 reg=new Registration12();
	//reg.setVisible(true);
}
